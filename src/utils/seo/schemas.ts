...
export const organizationSchema = {
  ...
  description: 'Agence de marketing digital spécialisée en SEO, publicité en ligne, social media et stratégie digitale pour PME ambitieuses. Basée à Carrières-sur-Seine, Île-de-France.',
  ...
  sameAs: [
    'https://www.facebook.com/share/1FyS9p9ngL/',
    'https://www.instagram.com/boostactivityfr',
    'https://www.linkedin.com/company/boost-activity/',
    'https://x.com/boostactivityfr',
  ],
  foundingDate: '2022',
  knowsAbout: [
    'Marketing Digital',
...
export const localBusinessSchema = {
  ...
  name: 'Boost Activity',
  alternateName: 'Boost Activity - Agence Marketing Digital Île-de-France',
  description: 'Agence de marketing digital spécialisée en stratégie digitale, SEO/SEA, social media et acquisition client pour PME et entreprises ambitieuses.',
  ...
  address: {
    '@type': 'PostalAddress',
    streetAddress: '2 Bis Rue Jules César',
    addressLocality: 'Carrières-sur-Seine',
    addressRegion: 'Île-de-France',
    postalCode: '78420',
    addressCountry: 'FR',
...
export const websiteSchema = {
  ...
  name: 'Boost Activity',
  url: 'https://boostactivity.fr',
  description: 'Agence de marketing digital en Île-de-France',
  publisher: {
    '@type': 'Organization',
    name: 'Boost Activity',
    logo: {
